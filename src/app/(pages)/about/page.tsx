        ...
        <PageContainer>
            <div className="mt-16 mb-8 text-center">
                <h1 className="text-6xl font-bold text-light">
                    About Project Kororā
                </h1>
            </div>

            <div className="bg-dark/40 backdrop-blur shadow-md text-light space-y-12 p-10 sm:p-12 lg:p-16 mt-10 mx-auto max-w-6xl">
                {/* Mission Overview */}
                <section>
                ...
                <section>
                    ...
                    <p className="text-light/80">
                        Our project name comes from the little blue penguin, or
                        kororā, Aotearoa New Zealand&apos;s smallest native
                        penguin. Like its namesake, our satellite is compact but
                        ambitious. With this mission, we hope to help shape the
                        future of student space exploration in Aotearoa and
                        contribute meaningfully to New Zealand&apos;s
                        high-growth aerospace sector.
                    </p>
                </section>

                {/* 2025 Objectives */}
                <section>
                    <h2 className="text-3xl font-bold mt-15 mb-4">
                ...
                <section className="text-center mt-10 pt-4">
                    <p className="text-light/90 text-lg font-medium italic">
                        Project Kororā brings together ambition, determination,
                        and community-driven design to push the boundaries of
                        what students can achieve in space.
                    </p>
                </section>
            </div>
        </PageContainer>
